        ...
        <div className="md:w-3/5 p-8 md:p-12 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            ...
            <p className="text-gray-600 mb-8 text-center md:text-left">
              Join ReportFlow to start designing with ease.
            </p>
            ...
            <form onSubmit={handleSubmit} className="auth-form">
              ...
              <div className="mt-2 text-sm text-gray-600">
                ...
                <Link href="/terms" className="text-[color:var(--primary-600)] hover:text-[color:var(--primary-700)]">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link href="/privacy" className="text-[color:var(--primary-600)] hover:text-[color:var(--primary-700)]">
                  Privacy Policy
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[color:var(--primary-600)] text-white py-2 px-4 rounded-md font-medium hover:bg-[color:var(--primary-700)] transition-colors flex items-center justify-center mt-6"
              >
                {isLoading ? (
                  <>
            ...
            <p className="mt-8 text-center text-sm text-gray-600">
              ...
              <Link href="/login" className="font-medium text-[color:var(--primary-600)] hover:text-[color:var(--primary-700)]">
                Sign in
              </Link>
            </p>
          </div>
